...
function ExploreView() {
  ...
  return <main id="main" className="wrap page"><h1 className="sr-only">Explore</h1><Board view={view} onView={next => router.replace(next === "coins" ? "/explore?view=coins" : "/explore")} /></main>;
}
