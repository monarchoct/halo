...
export default function Docs() {
  ...
  return <main id="main" className="wrap page docs">
    ...
    <article className="docs-body">
      ...
      <p><a href="/docs/HALO_LIVE_STATUS.md">Live progress board</a> · <a href="/docs/HALO_IMPLEMENTATION_SPEC.md">Implementation specification</a> · <a href="/docs/HALO_FEE_SETTLEMENT.md">Fee settlement</a> · <a href="/docs/HALO_GRADUATED_AGENT_TRADING.md">Graduated trading</a> · <a href="/docs/HALO_PUBLIC_ACTIVITY_AND_SOCIAL.md">Live and social design</a> · <a href="/docs/TALOS_MOTION_AND_SOUND.md">Motion and interface sound</a></p>
