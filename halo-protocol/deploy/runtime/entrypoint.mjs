...
const modes={operator:'runtime/cli.mjs',operations:'services/operations/cli.mjs',relays:'services/relay/cli.mjs',social:'runtime/social-cli.mjs',identity:'runtime/identity/cli.mjs',
...
if(mode==='check')console.log(JSON.stringify({service:'halo-runtime',status:'verified',node:process.version,...release}));
  ...
  if(!Object.hasOwn(modes,mode))throw new Error('Choose check, operator, operations, api, relays, social, identity, migrate or proof-benchmark');
